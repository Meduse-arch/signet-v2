  ...
  return (
    <div className="min-h-screen bg-[#050508] flex items-center justify-center p-4 sm:p-6 lg:p-8 relative overflow-hidden font-sans">
      <div className="absolute inset-0 w-full h-full">
        <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-indigo-950/40 via-[#050508] to-[#050508]"></div>
      ...
      <div className="relative z-10 w-full max-w-[1100px] flex flex-col lg:flex-row rounded-2xl sm:rounded-[2rem] overflow-hidden shadow-[0_0_40px_rgba(0,0,0,0.7)] border border-slate-800/80 bg-slate-950/80 backdrop-blur-2xl min-h-[500px] lg:min-h-[650px]">
        
        <div className="hidden lg:flex flex-col justify-between w-full lg:w-1/2 p-8 lg:p-14 relative overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-tr from-indigo-950/90 via-slate-900/40 to-transparent z-10 mix-blend-multiply"></div>
          ...
          <div className="relative z-20 mt-auto bg-slate-950/40 backdrop-blur-md p-6 rounded-3xl border border-white/10 shadow-2xl">
        ...
        <div className="w-full lg:w-1/2 p-8 sm:p-10 lg:p-14 flex flex-col justify-center bg-slate-950 relative z-20">
          ...
          <form onSubmit={handleAuth} className="space-y-5">
            ...
            <Button
              ...
              loading={loading}
              className="mt-8"
              rightIcon={<ArrowRight className="w-5 h-5 text-indigo-200 group-hover:translate-x-1 group-hover:text-white transition-all" />}
            >
          ...
          <div className="mt-8 text-center text-sm font-medium text-slate-400">
            ...
            <button
              ...
              className="text-white hover:text-indigo-400 transition-colors font-bold underline decoration-slate-700 hover:decoration-indigo-400 underline-offset-4 ml-1"
            >
